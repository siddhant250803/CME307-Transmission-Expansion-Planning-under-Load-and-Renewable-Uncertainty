...
\begin{itemize}
    \item Baseline DC-OPF and single-period TEP: if congestion alone were binding, the MILP would build.\todo{missing words}
...
The early representative-period runs expose feasibility tension in low-load hours because of minimum generation limits. Rather than ignore shortage, we price it explicitly. We created \todo{it is too long}
...
\section{Script-by-Script Insights} \todo{check that the description is correct}
